...
```
Agent(
  prompt="Read /Users/vs72964/Projects/gsd-benchmark/.cursor/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/vs72964/Projects/gsd-benchmark/.cursor/get-shit-done/templates/SECURITY.md`
