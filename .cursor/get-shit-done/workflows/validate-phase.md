...
```
Agent(
  prompt="Read /Users/vs72964/Projects/gsd-benchmark/.cursor/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/vs72964/Projects/gsd-benchmark/.cursor/get-shit-done/templates/VALIDATION.md`
