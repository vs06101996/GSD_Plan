...
```bash
INIT=$(node "/Users/vs72964/Projects/gsd-benchmark/.cursor/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "/Users/vs72964/Projects/gsd-benchmark/.cursor/get-shit-done/bin/gsd-tools.cjs" commit \
