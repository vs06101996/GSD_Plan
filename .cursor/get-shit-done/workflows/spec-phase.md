...
```bash
INIT=$(node "/Users/vs72964/Projects/gsd-benchmark/.cursor/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/Users/vs72964/Projects/gsd-benchmark/.cursor/get-shit-done/templates/spec.md.
