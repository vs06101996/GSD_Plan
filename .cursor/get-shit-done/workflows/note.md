...
- **Global scope**: `/Users/vs72964/Projects/gsd-benchmark/.cursor/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/vs72964/Projects/gsd-benchmark/.cursor/notes/`)
...
2. Glob `/Users/vs72964/Projects/gsd-benchmark/.cursor/notes/*.md` (if directory exists) — global notes
...
Global (/Users/vs72964/Projects/gsd-benchmark/.cursor/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/vs72964/Projects/gsd-benchmark/.cursor/notes/` — works in any directory
